describe('Logout', () => {
  ...
  it('User should navigate to main screen', () => {
    ...
    cy.get('#logoutEmail').invoke('val', 'Ethmane.Bilal@stud.noroff.no');
    cy.get('#logoutPassword', { timeout: 10000 }).type('qwerldskfjls23');
    cy.get('#logout-link', { timeout: 10000 }).click();
